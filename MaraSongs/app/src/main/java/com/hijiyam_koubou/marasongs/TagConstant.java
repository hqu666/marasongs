...
public class TagConstant {
    ...
    static {
        ...
        languageIdToString.put("gwi", "Gwichｴin");
        ...
        languageIdToString.put("jpn", "Japanese");							//日本語
        ...
        languageIdToString.put("nob", "Norwegian Bokm虱");
        ...
        languageIdToString.put("oci", "Occitan (post 1500); Proven軋l");
        ...
        languageIdToString.put("pro", "Proven軋l, Old (to 1500)");
        ...
        languageIdToString.put("vol", "Volap・");
